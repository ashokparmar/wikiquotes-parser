...
class Reader:
    ...
    def occationally_save(self, interval=BLOCK_SIZE):
        ...
        self.counter += 1 
	print "counter: ", self.counter, "interval:", interval
	...
	print "Saving data"
        ...
        print "saving Cassandra", self.raw.send()
        print "saving redis", self.que.save()
    ...
    def split_into_pages(self, input_file):
        ...
        for line in input_file:
            if '<page>' in line:
                ...
                yield self.create_page_key_and_body(
                    itertools.chain(iter(['<page>']), input_file))
    ...
    def run(self, input_file):
        ...
        '''
        try:
            for key, body in self.split_into_pages(input_file):
